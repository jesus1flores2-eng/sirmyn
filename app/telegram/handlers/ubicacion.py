...
from app.telegram.common.utils import user_data, limpiar_estado, actualizar_timestamp_usuario, buscar_coincidencias_flexibles, _normalize_text
...
# ============================================================
# HANDLER: ELEGIR UBICACIÓN (GPS o Manual)
# ============================================================
...
async def elegir_ubicacion_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Si no reconoce la opción, mostrar el menú de nuevo
    keyboard = [
...
# ============================================================
# HANDLER: UBICACIÓN GPS (DURANTE EL REPORTE)
# ============================================================
...
# ============================================================
# HANDLER: LOCALIDAD (entrada manual)
# ============================================================
...
# ============================================================
# HANDLER: SUGERENCIAS DE LOCALIDAD
# ============================================================
...
# ============================================================
# FUNCIÓN: SOLICITAR UBICACIÓN EXACTA (PROBLEMA DE UBICACIÓN)
# ============================================================
...
async def solicitar_ubicacion_exacta_al_reportante(reporte_id: int, cuadrilla_nombre: str, context=None):
    ...
    try:
        ...
        with app.app_context():
            ...
            # Cambiar estado a "Problema ubicación"
...
# ============================================================
# HANDLER: RESPUESTA A PROBLEMA DE UBICACIÓN (GPS)
# ============================================================
...
async def manejar_ubicacion_problema_gps(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        with app.app_context():
            ...
            # Notificar a la cuadrilla asignada
